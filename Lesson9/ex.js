...
//kiem tra 3 canh tam giac

// function triangle(a,b,c){
//     if((a+b)>c && (a+c)>b && (b+c)>a){
//         console.log('day la 3 canh tam giac');
//         return true;
//     }
//     else{
//         console.log('day ko la 3 canh tam giac');
//         return false;
//     }
// }
...
//nhap key word theo name

// let keyword = prompt('nhap ten can tim');
// let isTrue= false;
...
//     name : 'Vinmart',
//     address : 'Cau Giay',
//     owner : 'Pham Nhat Vuong',
//     item : [
//         {id: 1, name: 'iphone', category: 'phone', price: 999},
//         {id: 2, name: 'samsung', category: 'phone', price: 899},
//         {id: 3, name: 'ipod', category: 'headset', price: 199}
//     ]
// }
...
// do{
//     let n = Number(prompt('nhap vao chuc nang 1->4:'))
//     if(n==1){
//         store.name = prompt('nhap lai ten kho hang');
//         store.address = prompt('nhap lai dia chi');
//         store.owner = prompt('nhap lai ten chu kho');
//         alert(store.name);
//     }
//     else if(n==2){
//         store.item[1].id
